    ...
    : window(nullptr), renderer(nullptr), font(nullptr), sound(nullptr)
{
    ...
    if (!renderer) {
        ...
        SDL_DestroyWindow(window); Mix_Quit(); TTF_Quit(); SDL_Quit();
    ...
    if (!font) {
        ...
        SDL_DestroyRenderer(renderer); SDL_DestroyWindow(window); Mix_Quit(); TTF_Quit(); SDL_Quit();
...
Engine::~Engine() {
    ...
    Mix_CloseAudio(); Mix_Quit(); TTF_Quit(); SDL_Quit();
}
